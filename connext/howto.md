...
**จะทำอย่างไรเมื่อเป็นเพื่อนกับ Line OA แล้ว**

{% hint style="success" %}
หากคุณเคยเป็นเพื่อนกับ Line OA ของ 724 Market อยู่แล้ว คุณยังคงต้อง กดเชื่อมต่อ 724 Connext ใหม่อีกครั้ง เพื่อเป็นการยืนยันบัญชีของคุณในฐานะ 724 Agent 
การเชื่อมต่อใหม่จะช่วยให้ระบบสามารถอัพเดตข้อมูลบัญชีและเปิดใช้งานฟีเจอร์สำหรับ 724 Agent ได้อย่างสมบูรณ์
{% endhint %}
...
**กดเพื่อเชื่อมต่อ**
   - เมื่อพบกล่อง "เชื่อมต่อ 724 Connext" ให้กดเชื่อมต่อ
   - ทำตามขั้นตอนที่ปรากฏบนหน้าจอเพื่อดำเนินการเชื่อมต่อบัญชี
     
**เข้าสู่ระบบ Line (ถ้ามี)**
   - หากระบบต้องการเข้าสู่ระบบ ให้กรอกข้อมูลบัญชีผู้ใช้ที่คุณลงทะเบียน Line
