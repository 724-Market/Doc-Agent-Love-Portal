...
{% hint style="success" %}
ในกรณีที่คุณเคยเป็นเพื่อนกับ Line OA ของ 724 Market อยู่แล้ว คุณยังคงต้อง กดเชื่อมต่อ 724 Connext ใหม่อีกครั้ง เพื่อเป็นการยืนยันบัญชีของคุณในฐานะ 724 Agent

การเชื่อมต่อใหม่จะช่วยให้ระบบสามารถอัปเดตข้อมูลบัญชีและเปิดใช้งานฟีเจอร์สำหรับ 724 Agent ได้อย่างสมบูรณ์
{% endhint %}
