...
1. แสกน QR : ไม่มีค่าธรรมเนียม
2. บัตรเครดิต/บัตรเครดิต : ค่าธรรมเนียม 2%
3. วงเงินมัดจำ : ไม่มีค่าธรรมเนียม

ช่องทางการใช้ส่วนลด แบ่งออกเป็น 3 รูปแบบ คือ
1. หักส่วนลดเต็มจำนวน : ใช้ส่วนลดทั้งหมดในการชำระเงิน
2. หักส่วนลดเต็มบางส่วน : ใช้ส่วนลดบางส่วนตามที่กำหนด
3. ชำระเบี้ยเต็มจำนวน : ไม่ใช้ส่วนลดและชำระเงินเต็มจำนวน
...
<figure>
    <img src="https://drive.google.com/uc?export=view&id=19mm-x6RwNLUOMO68NwHGk6RFqf8BOp36" alt="" style="width: 70%; max-width: 300px;">
    <figcaption></figcaption>
</figure>
...
<figure>
    <img src="https://drive.google.com/uc?export=view&id=1E12IOCW_4q4vB_r7b5a9r5_L60jUS_RI" alt="" style="width: 70%; max-width: 300px;">
    <figcaption></figcaption>
</figure>
...
<figure>
    <img src="https://drive.google.com/uc?export=view&id=1kuk4fRNr0507UJoUhA_dwFXi7jGWpzkk" alt="" style="width: 70%; max-width: 300px;">
    <figcaption></figcaption>
</figure>
